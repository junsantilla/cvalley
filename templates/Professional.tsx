                ...
                <div className="a4 border p-10 bg-white" id="element-to-capture">
                    ...
                    <ul>
                        {data.employment?.map((job: any, index: number) => (
                            <li key={index}>
                                {job.companyName} - {job.jobTitle}, {job.city} ({job.startYear} - {job.endYear})<p>{job.description}</p>
                            </li>
                        ))}
                    </ul>
                    ...
                    <ul>
                        {data.education?.map((school: any, index: number) => (
                            <li key={index}>
                                {school.schoolName} - {school.degree}, {school.fieldOfStudy} ({school.startYear} - {school.endYear})<p>{school.description}</p>
                            </li>
                        ))}
                    </ul>
