...
export const metadata: Metadata = {
    title: "CValley - Privacy Policy",
    description: "Learn about CValley's privacy policy. Understand how we handle personal information on our CV Builder platform, ensuring the security and privacy of our users' data.",
}
