...
export const metadata: Metadata = {
    title: "CValley - Terms of Service",
    description: "Read and agree to the terms of service for CValley's free resume-building platform. Understand the conditions for using our services, including information on user responsibilities, platform access, and more.",
}
