...
const AddDummyDataButton: React.FC<AddDummyDataButtonProps> = ({ onDataAdd }) => {
    const handleAddDummyData = () => {
        ...
        // Display an alert to confirm data override
        const isConfirmed = existingData && window.confirm("This will override existing data. Are you sure you want to proceed?")

        // If the user confirms or if there's no existing data, proceed with adding the dummy data
        if (!existingData || (existingData && isConfirmed)) {
            ...
            const dummyData = {
                ...
                employment: [
                    ...
                    },
                    {
                        ...
                        endYear: 2023,
                        description:
                            "Led a team of developers in the design and implementation of cutting-edge software solutions. Contributed to the architectural decisions and mentored junior team members. Implemented best practices to enhance code quality and maintainability.",
                    },
                    {
